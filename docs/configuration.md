...
warnings and Hermeto continues. The SBOM may be incomplete or inaccurate.
...
For how permissive violations are tracked in SBOM output, see
...
backends. A few settings, such as proxy configuration, are shared across a
subset of backends.
