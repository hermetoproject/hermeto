...
class PropertyEnum(str, Enum):
    ...
    PROP_FOUND_BY_EXPERIMENTAL = f"{APP_NAME}:found_by:experimental_package_manager"
...
class PropertySet:
    ...
    found_by_experimental: str | None = None
    ...
    def from_properties(cls, props: Iterable[Property]) -> "Self":
        ...
        for prop in props:
            if prop.name == PropertyEnum.PROP_BUNDLER_PACKAGE_BINARY:
                ...
                found_by = prop.value
            elif prop.name == PropertyEnum.PROP_FOUND_BY_EXPERIMENTAL:
                found_by_experimental = prop.value
    ...
    def to_properties(self) -> list[Property]:
        ...
        if self.found_by_experimental:
            props.append(
                Property(
                    name=PropertyEnum.PROP_FOUND_BY_EXPERIMENTAL, value=self.found_by_experimental
                )
            )
        props.extend(
    ...
    def merge(self, other: "Self") -> "Self":
        ...
        return cls(
            ...
            found_by_experimental=self.found_by_experimental or other.found_by_experimental,
