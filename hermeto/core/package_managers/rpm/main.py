...
from hermeto.core.models.sbom import Component, Property, create_package_manager_annotation
...
def fetch_rpm_source(request: Request) -> RequestOutput:
    ...
    pm_annotation = create_package_manager_annotation(components, "rpm")
