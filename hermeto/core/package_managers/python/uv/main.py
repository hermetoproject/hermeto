...
def _resolve_uv(package_dir: RootedPath, output_dir: RootedPath) -> UvResolutionResult:
    ...
    return UvResolutionResult(name=name, version=version, components=components)
