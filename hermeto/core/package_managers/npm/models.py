...
from hermeto.core.package_managers.npm.types import NpmComponentInfo
from hermeto.core.package_managers.npm.urls import _classify_resolved_url, _normalize_resolved_url
