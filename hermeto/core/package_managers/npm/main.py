...
from hermeto.core.package_managers.npm import urls as npm_urls
from hermeto.core.package_managers.npm.models import Package, PackageLock
from hermeto.core.package_managers.npm.purl import _Purlifier
from hermeto.core.package_managers.npm.types import (
    DEPENDENCY_TYPES,
    NpmComponentInfo,
    ResolvedNpmPackage,
)
...
NPM_REGISTRY_CNAMES = npm_urls.NPM_REGISTRY_CNAMES
...
def _update_vcs_url_with_full_hostname(vcs: str) -> str:
    return npm_urls._update_vcs_url_with_full_hostname(vcs)
