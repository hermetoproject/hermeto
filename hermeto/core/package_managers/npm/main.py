...
def _normalize_resolved_url(resolved_url: str) -> NormalizedUrl:
    return normalize_resolved_url(resolved_url)


def _classify_resolved_url(resolved_url: NormalizedUrl) -> str:
    return classify_resolved_url(resolved_url)


def _update_vcs_url_with_full_hostname(vcs: str) -> str:
    return update_vcs_url_with_full_hostname(vcs)


def _extract_git_info_npm(vcs_url: NormalizedUrl) -> dict[str, str]:
    return extract_git_info_npm(vcs_url)
