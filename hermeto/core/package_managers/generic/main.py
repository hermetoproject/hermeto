...
from hermeto.core.errors import InvalidLockfileFormat, LockfileNotFound, PathOutsideRoot
...
def _resolve_generic_lockfile(lockfile_path: Path, output_dir: RootedPath) -> list[Component]:
    ...
    if not lockfile_path.exists():
        raise LockfileNotFound(lockfile_path=lockfile_path, lockfile_name=DEFAULT_LOCKFILE_NAME)
