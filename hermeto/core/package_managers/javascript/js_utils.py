...
def parse_git_clone_url(url: str, ref: str | None = None) -> GitCloneUrl:
    ...
    >>> parse_git_clone_url("http://github.com/example-org/example-repo")
    GitCloneUrl(url='http://github.com/example-org/example-repo', ref='', host='github.com', namespace='example-org', repo='example-repo')
    >>> parse_git_clone_url("ssh://github.com/example-org/example-repo.git#abc123")
    GitCloneUrl(url='ssh://github.com/example-org/example-repo.git', ref='abc123', host='github.com', namespace='example-org', repo='example-repo')
    >>> parse_git_clone_url("git://github.com/example-org/example-repo#abc123")
    GitCloneUrl(url='git://github.com/example-org/example-repo', ref='abc123', host='github.com', namespace='example-org', repo='example-repo')
    ...
    >>> parse_git_clone_url("github.com:example-org/example-repo#abc123")
    GitCloneUrl(url='github.com:example-org/example-repo', ref='abc123', host='github.com', namespace='example-org', repo='example-repo')
    ...
    >>> parse_git_clone_url("https://github.com/example-org-no-repo")
    Traceback (most recent call last):
    ...
    hermeto.core.errors.UnexpectedFormat: ...
    >>> parse_git_clone_url("ftp://github.com/example-org/example-repo.git")
    Traceback (most recent call last):
    ...
    hermeto.core.errors.UnexpectedFormat: ...
    >>> parse_git_clone_url("git@github.com/example-org/example-repo")
    Traceback (most recent call last):
    ...
    hermeto.core.errors.UnexpectedFormat: ...
    """
