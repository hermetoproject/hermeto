...
from tests.integration.utils import DEFAULT_INTEGRATION_REPO
...
def pytest_addoption(parser: pytest.Parser) -> None:
    ...
    group.addoption(
        "--integration-repo",
        action="store",
        default=os.getenv("HERMETO_TEST_INTEGRATION_TESTS_REPO", DEFAULT_INTEGRATION_REPO),
    ...
    group.addoption(
        "--container-engine",
        action="store",
        default=os.getenv("HERMETO_TEST_CONTAINER_ENGINE", "podman").lower(),
