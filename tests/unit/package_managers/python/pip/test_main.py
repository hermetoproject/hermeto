...
from hermeto.core.models.input import PipPackagingTool
...
from hermeto.core.package_managers.python.pip.pylock import PyLockfileV1
from hermeto.core.rooted_path import RootedPath
from tests.common_utils import GIT_REF
from tests.unit.package_managers.python.pip.test_pylock import write_pylock_toml
...
class TestDownloadPylock:
    ...
    @mock.patch("hermeto.core.package_managers.python.pip.main._get_pip_metadata")
    @mock.patch("hermeto.core.package_managers.python.pip.main._download_from_lockfiles")
    @mock.patch("hermeto.core.package_managers.python.pip.main.filter_packages_with_rust_code")
