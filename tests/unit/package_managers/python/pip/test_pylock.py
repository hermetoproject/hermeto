...
from hermeto.core.package_managers.python.pip.pylock import (
...
class TestPyLockVCSPackage:
    """Tests for VCS packages parsed via ``from_package_data``."""
...
class TestPyLockArchivePackage:
    """Tests for archive packages parsed via ``from_package_data``."""
