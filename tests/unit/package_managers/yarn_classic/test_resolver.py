...
@mock.patch("hermeto.core.package_managers.yarn_classic.resolver.get_repo_id")
def test_package_purl_without_vcs_url(
    mock_handle_get_repo_id: mock.Mock, rooted_tmp_path: RootedPath
) -> None:
    """Test that file/workspace/link packages omit vcs_url when repo_id is None."""
