...
from tests.integration.utils import DEFAULT_INTEGRATION_REPO, TEST_SERVER_LOCALHOST
...
def pytest_configure(config: pytest.Config) -> None:
    ...
    os.environ["HERMETO_TEST_INTEGRATION_TESTS_REPO"] = config.getoption("--integration-repo")
    os.environ["HERMETO_IMAGE"] = config.getoption("--hermeto-image")
