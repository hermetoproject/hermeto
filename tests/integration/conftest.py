...
def _start_nexusserver() -> None:
    ...
    # Unlike PyPI and DNF servers - child processes killed when the parent - exits, Nexus runs
    # as a detached podman container that survives process termination. No explicit teardown is
    # performed here.
...
def pytest_sessionfinish(session: pytest.Session) -> None:
    ...
    # NOTE: The Nexus server is a detached podman container and is intentionally not
    # torn down here, it has its own cleanup sequence.
